...
![softwareTest book](img/softwaretest_book_zero.png)
...
テスト駆動開発でバイブルとされている2冊
* テスト駆動開発 Kent Beck (著), 和田 卓人 (翻訳)
* 実践テスト駆動開発 Steve Freeman (著), Nat Pryce (著), 和智 右桂  (翻訳), 高木 正弘  (翻訳)

TDD Boot Camp 2020 Online 基調講演のアーカイブが[YouTube](https://www.youtube.com/watch?v=Q-FJ3XmFlT8)で公開されていて参考になった
...
セキュリティに関する脆弱性情報の収集方法として、例えばIPAが公開している`icat for JSON`などがある
...
テストケース生成ツールの使用も検討する
* [PICT](https://github.com/microsoft/pict) (ペアワイズ法による組み合わせテストケース生成ツール)
